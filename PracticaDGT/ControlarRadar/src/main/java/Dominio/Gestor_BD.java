...
public class Gestor_BD {
	...
	public void Introducir_exp(Expediente exp,AgenteBBDD agente){
		
		agente.Insertar_Expediente(exp);
	
	}
	public Expediente devolver_exp(int id,AgenteBBDD agente){
		Expediente exp=null;
		
		exp=agente.getExpediente(id);
		
		return exp;
		
		
	}
	public  ArrayList <Integer> devolver_IdsExpediente(AgenteBBDD agente){
		ArrayList <Integer>  exp = new ArrayList<Integer>();
		exp= agente.get_idExp();
		return exp;
	}
}
